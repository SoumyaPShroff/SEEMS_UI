...
const RaiseFlagRegister = () => {
  ...
  const pendingColumns: GridColDef[] = [
    ...
    { field: "projectApprovedHrs", headerName: "Project Approved Hrs", flex: 1, minWidth: 120 },
    { field: "ecoApprovedHrs", headerName: "ECO Approved Hrs", flex: 1, minWidth: 120 },
    { field: "invoicedHrs", headerName: "Invoiced Hrs"  },
    { field: "invoiceAmount", headerName: "Invoice Amt"  },
  ...
  const invoicedColumns: GridColDef[] = [
    ...
    { field: "projectApprovedHrs", headerName: "Project Approved Hrs", flex: 1, minWidth: 120 },
    { field: "ecoApprovedHrs", headerName: "ECO Approved Hrs", flex: 1, minWidth: 120 },
    { field: "invoicedHrs", headerName: "Invoiced Hrs", flex: 1, minWidth: 130 },
    { field: "invoiceAmount", headerName: "Invoice Amt", flex: 1, minWidth: 110 },
        { field: "invoiceNo", headerName: "Invoice No", flex: 1, minWidth: 120 },
    { field: "projectmanager", headerName: "Project Manager", flex: 1, minWidth: 170 },
