...
//         if (!enquiryNo) return;
//         if (lookups.customers.length === 0) return; // wait until lookup lists loaded
...
//                 const data = response[0];   // <-- IMPORTANT FIX
